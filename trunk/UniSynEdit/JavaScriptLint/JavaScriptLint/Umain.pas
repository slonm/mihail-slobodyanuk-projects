...
begin
  ...
  for i:=0 to JSLOptionsCount-1 do
    begin
    if lst1.Checked[i] then switch:='+' else switch:='-';
...
begin
  ...
  begin
    ...
    if sl[2]='' then parent:=NodeError
    else parent:=NodeWarning;
