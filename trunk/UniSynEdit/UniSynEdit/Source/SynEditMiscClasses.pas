...
type
  ...
  private
    ...
    procedure SetHighlightChanges(Value: boolean);
  public
    constructor Create;
  ...
  published
    ...
    property OnChange: TNotifyEvent read fOnChange write fOnChange;
    //Highlight changes in string
    property HighlightChanges: boolean read fHighlightChanges write SetHighlightChanges default TRUE;
  end;
  //### Code Folding ###
...
//    procedure SetCollapsedLineStyle(const Value: TPenStyle);
  public
    constructor Create;
    destructor Destroy; override;
  ...
  published
    ...
    property CollapsedLineColor: TColor read fCollapsedLineColor
    	write SetCollapsedLineColor default clSilver;
    ...
    property CollapsedLineStyle: TPenStyle read fCollapsedLineStyle write fCollapsedLineStyle default psDot;
...
procedure TSynGutter.SetHighlightChanges(Value: boolean);
begin
  if fHighlightChanges <> Value then begin
    fHighlightChanges := Value;
    if Assigned(fOnChange) then fOnChange(Self);
  end;
end;
...
{
procedure TSynCodeFolding.SetCollapsedLineStyle(const Value: TPenStyle);
begin
	fCollapsedLineStyle := Value;
