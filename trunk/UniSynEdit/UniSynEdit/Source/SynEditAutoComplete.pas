...
type
  ...
  public
    ...
    procedure ExecuteCompletion(const AToken: UnicodeString; AEditor:
      TCustomSynEdit);
      virtual;
  ...
  public
    ...
    property EndOfTokenChr: UnicodeString read fEOTokenChars write
      fEOTokenChars;
  end;
...
procedure TCustomSynAutoComplete.AddCompletion(const AToken, AValue, AComment:
  UnicodeString);
begin
  if AToken <> '' then
  begin
